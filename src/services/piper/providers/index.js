  ...
  switch (kind) {
    case "vertex-ai":
      return new VertexAiProvider({
        project: config.piperGcpProject,
        location: config.piperGcpLocation,
    ...
    default:
      ...
      throw new Error(`invalid PIPELINE_PIPER_PROVIDER: "${kind}" (expected none, openai-compatible, anthropic, or vertex-ai)`);
  }
}

export { NullProvider, OpenAiCompatibleProvider, AnthropicProvider, VertexAiProvider };
